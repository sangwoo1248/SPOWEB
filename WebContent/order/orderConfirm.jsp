...
<input type="hidden" name="gCode" value="${cDTO.sCode}">
<input type="hidden" name="gName" value="${cDTO.sName}">
<input type="hidden" name="gPrice" value="${cDTO.sPrice}">
<input type="hidden" name="gSize" value="${cDTO.sSize}">
<input type="hidden" name="gColor" value="${cDTO.sColor}">
<input type="hidden" name="gAmount" value="${cDTO.sAmount}">
<input type="hidden" name="gImage" value="${cDTO.sImage}">
			...
			<td>
				<table width="100%" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						${cDTO.gName}
							<br> <font size="2" color="#665b5f">[옵션 : 사이즈(${cDTO.sSize})
								, 색상(${cDTO.gColor})]
						</font></td>
